        ...
        <Box sx={{display:'flex'}} >
            ...
            >
                <Toolbar sx={myStyles.toolbar}>
                    ...
                    <Button sx={ myStyles.toolbar_button } onClick={handleDialogOpen}>Add A Brick Set</Button>
                            {/*Dialog Pop Up begin */}
                            <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labelledby="form-dialog-title">
                            <DialogTitle id="form-dialog-title">Add New Brick</DialogTitle>
                            <DialogContent>
                                <DialogContentText>Add A New Brick</DialogContentText>
                                    <BrickForm />
                            </DialogContent>
                            <DialogActions>
